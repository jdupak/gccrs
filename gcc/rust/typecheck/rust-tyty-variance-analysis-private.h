...
template <typename VARIANCE> class Visitor final : public TyVisitor
{
  VarianceVisitorCtx<VARIANCE> &ctx;
  VARIANCE variance;

public:
  Visitor (VarianceVisitorCtx<VARIANCE> &ctx, VARIANCE variance)
...
{
public:
  using Visitor = Visitor<Variance>;
