...
public:
  ...
  [[nodiscard]] PlaceId get_place () const { return place; }
  [[nodiscard]] AbstractExpr &get_expr () const { return *expr; }
};
...
public:
  ...
  [[nodiscard]] bool is_goto_terminated () const
  {
...
public:
  template <size_t I>[[nodiscard]] PlaceId get_operand () const
  {
...
public:
  [[nodiscard]] PlaceId get_rhs () const { return rhs; }
};
...
public:
  ...
  [[nodiscard]] PlaceId get_callable () const { return callable; }
};
