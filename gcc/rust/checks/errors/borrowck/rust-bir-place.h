...
struct Lifetime
{
  ...
  [[nodiscard]] bool has_lifetime () const { return id != INVALID_LIFETIME_ID; }
  LifetimeID operator() () const { return id; }
};
constexpr Lifetime NO_LIFETIME = Lifetime{INVALID_LIFETIME_ID};
constexpr Lifetime STATIC_LIFETIME = Lifetime{STATIC_LIFETIME_ID};
